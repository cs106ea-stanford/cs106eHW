...
class EmbedSet:
    vocab: torchtext.vocab.vectors.GloVe
...
# Allow Colab Notebook to set the Embed
# we do this so that the student can see progress as the GloVe is loaded
def set_glove_embed(glove: GloVe):
    global vs
    vs = EmbedSet(
                    glove,
